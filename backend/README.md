...
## Project Structure
    ...
    ├── addedchcedudfufifn_117526  # Django project configurations
...
1. Clone this repo and `cd addedchcedudfufifn_117526`
...
2. Clone this repo and `cd addedchcedudfufifn_117526`
